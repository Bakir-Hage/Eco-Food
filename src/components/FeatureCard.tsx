...
export default function FeatureCard() {
  return (
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm border hover:shadow-md transition-shadow">
            ...
            <p className="text-muted-foreground">
              Food Waste Mitigation: It prevents perfectly edible food from
              ending up in landfills, where it would otherwise produce methane
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm border hover:shadow-md transition-shadow">
            ...
            <p className="text-muted-foreground">
              Be part of a growing community committed to sustainability.
